    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <FormProgress
          currentStep={step}
          totalSteps={5}
          labels={['Infos', 'Lieu', 'Prix', 'Équip.', 'Photos']}
        />
          ...
          {step === 5 && (
            <div className="space-y-6">
              ...
              <div className="p-6 bg-gray-50 rounded-lg space-y-3">
                <h4 className="text-gray-900 mb-3">Récapitulatif de votre annonce</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-gray-600">Bateau :</span>
                    <span className="text-gray-900 ml-2">{basicInfo.name}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-gray-900 ml-2">{location.city}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Prix :</span>
                    <span className="text-gray-900 ml-2">{details.price}€/jour</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Capacité :</span>
                    <span className="text-gray-900 ml-2">{basicInfo.capacity} pers.</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Équipements :</span>
                    <span className="text-gray-900 ml-2">{equipment.length}</span>
                  </div>
                </div>
              </div>
            </div>
